...
Code & README generated by Claude. Accuracy is what it is
...
- **Simulation Plot**: Scatter plot showing individual simulation results with:
  ...
  - Red band: 95% confidence interval
...
- Memory limits enforced at 10M events
...
- **Testing**: Chrome/Firefox/Safari latest versions
...
1. Export functionality (CSV, images)
2. Preset configurations
3. Comparison mode (multiple scenarios)
4. Historical tracking of parameter changes
